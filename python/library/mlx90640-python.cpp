...
int setup(int address, int fps){
	mlxAddress = address;
	MLX90640_SetDeviceMode(mlxAddress, 0);
	MLX90640_SetSubPageRepeat(mlxAddress, 0);

	//int t = (1000000 / fps) + OFFSET_MICROS;

	switch(fps){
		case 1:
			MLX90640_SetRefreshRate(mlxAddress, 0b001);
			baudrate = 400000;
			break;
		case 2:
			MLX90640_SetRefreshRate(mlxAddress, 0b010);
			baudrate = 400000;
			break;
		case 4:
			MLX90640_SetRefreshRate(mlxAddress, 0b011);
			baudrate = 400000;
			break;
		case 8:
			MLX90640_SetRefreshRate(mlxAddress, 0b100);
			baudrate = 400000;
			break;
		case 16:
			MLX90640_SetRefreshRate(mlxAddress, 0b101);
			baudrate = 1000000;
			break;
		case 32:
			MLX90640_SetRefreshRate(mlxAddress, 0b110);
			baudrate = 1000000;
			break;
		case 64:
			MLX90640_SetRefreshRate(mlxAddress, 0b111);
			baudrate = 1000000;
			break;
		default:
#ifdef DEBUG
	...
	MLX90640_SetChessMode(mlxAddress);
